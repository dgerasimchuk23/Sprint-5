...
func (w Walking) Calories() float64 {
	...
	speedSquaer := SpeedMSec * SpeedMSec
	return ((CaloriesWeightMultiplier*w.Weight + (speedSquaer/(w.Height/CmInM))*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours)
}
